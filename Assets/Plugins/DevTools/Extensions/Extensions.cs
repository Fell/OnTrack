...
namespace FluffyUnderware.DevTools.Extensions
{
    ...
    public static class Vector3Ext
    {
        ...
        {
            return Vector3.SqrMagnitude(v1 - v2) < 0.000001f;
        }
    ...
    public static class TypeExt
    {
        ...
        /// <summary>
        /// Gets all types (Crossplatform) from a specific assembly
        /// </summary>
        ...
        {
#if NETFX_CORE
            Assembly assembly = typeFromAssembly.GetTypeInfo().Assembly;
